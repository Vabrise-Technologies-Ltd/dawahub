const Newsletter = () => {
    return ( 
        <div className="bg-gradient-to-r from-cyan-500 to-cyan-700 via-cyan-600 md:p-16 p-6 grid md:grid-cols-2 md:gap-32 gap-4">
            <div className="section-title text-left text-white font-bold">
